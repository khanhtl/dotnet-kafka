...
public class PostAggregate : AggregateRoot
{
    ...
    public void AddComment(string comment, string userName)
    {
        if (!_active)
        {
            throw new InvalidOperationException("You cannot add the comment of an inactive post!");
        }
    ...
    public void EditComment(Guid commentId, string comment, string userName)
    {
        ...
        {
            throw new InvalidOperationException("You are not allowed to edit a comment that was made by onother user");
        }
    ...
    public void RemoveComment(Guid commentId, string userName)
    {
        ...
        if (!_comments[commentId].Item2.Equals(userName, StringComparison.OrdinalIgnoreCase))
        {
            throw new InvalidOperationException("You are not allowed to remove a comment that was made by onother user");
        }
    ...
    public void RemovePost(string userName)
    {
        ...
        {
            throw new InvalidOperationException("You are not allowed to remove a post that was made by onother user");
        }
